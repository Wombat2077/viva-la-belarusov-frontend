<template>
    <div class="max-w-xs">
        <div class="max-w-10 -mb-10 relative z-5 transition duration-200 ease-linear opacity-0 hover:opacity-100" @click="emit('update:model')">
            <svg  viewBox="0 0 24 24" :fill="starColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <img :src="image" class="sm:min-w-full -z-1">
...
<script setup>
    ...
    const starColor = computed(() => {
        return model.value?" yellow": "transparent";
    })
</script>